...
Most of these come down to network reality or how rdap serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

rdap rate-limits like any public site. rdap already paces
...
Where a surface is gated, rdap reads a cookie or token you supply
...
`rdap`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what rdap actually did
