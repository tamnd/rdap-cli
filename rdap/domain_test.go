...
// HTTP behaviour is covered in rdap_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "rdap://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("rdap", "about")
	if err != nil || got.String() != "rdap://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want rdap://page/about", got.String(), err)
	}
}
